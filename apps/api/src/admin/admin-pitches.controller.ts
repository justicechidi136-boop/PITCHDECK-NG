...
export class AdminPitchesController {
  ...
  list(
    ...
    return this.adminPitchesService.listPitches(user, {
      status,
      stateId,
  ...
  startReview(@CurrentUser() user: RequestUser, @Param("pitchId") pitchId: string) {
  ...
  approve(@CurrentUser() user: RequestUser, @Param("pitchId") pitchId: string) {
  ...
  @Post(":pitchId/reopen")
  reopen(@CurrentUser() user: RequestUser, @Param("pitchId") pitchId: string) {
    return this.adminPitchesService.reopen(user, pitchId);
  }

  @Post(":pitchId/suspend-discovery")
  suspendDiscovery(@CurrentUser() user: RequestUser, @Param("pitchId") pitchId: string) {
